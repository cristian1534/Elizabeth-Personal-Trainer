          ...
          <div class="row">
            <div class="col-lg-6 offset-lg-3">
              <div class="section-heading dark-bg">
                <h2>
                  Horarios de <em>Entrenamiento</em>
                </h2>
                <p>
                  Lorem ipsum dolor, sit amet consectetur adipisicing elit.
                  Nesciunt deleniti est fugit itaque repellendus. Animi
                  molestias quod in officiis molestiae aperiam, nihil est maxime
                  similique voluptatem culpa inventore fugit deserunt.
                </p>
              </div>
            </div>
          </div>
